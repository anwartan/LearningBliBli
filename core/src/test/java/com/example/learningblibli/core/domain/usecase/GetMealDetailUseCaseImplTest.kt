...
import com.example.learningblibli.core.domain.usecase.impl.GetMealDetailUseCaseImpl
...
class GetMealDetailUseCaseImplTest{
    ...
    @InjectMocks
    private lateinit var getMealDetailUseCaseImpl: GetMealDetailUseCaseImpl
    ...
    fun getMealDetail(){
        ...
        val actualResult = getMealDetailUseCaseImpl(1).blockingFirst()
