...
import com.example.learningblibli.core.domain.usecase.impl.GetFavoriteMealByIdUsecaseImpl
...
class GetFavoriteMealByIdUsecaseImplTest{

    @Mock
    private lateinit var mealRepository: MealRepository
    @InjectMocks
    private lateinit var getFavoriteMealByIdUsecaseImpl: GetFavoriteMealByIdUsecaseImpl
    ...
    fun getFavoriteMealById():Unit = runBlocking{
        ...
        val actualResult = getFavoriteMealByIdUsecaseImpl(1)
