...
import com.example.learningblibli.core.domain.usecase.impl.LoginByFirebaseUseCaseImpl
...
class LoginByFirebaseUseCaseImplTest{

    @Mock
    private lateinit var authRepository: AuthRepository
    @InjectMocks
    private lateinit var loginByFirebaseUseCaseImpl: LoginByFirebaseUseCaseImpl
    @Before
    fun setUp(){
    ...
    fun loginByFirebaseUseCaseTest() = runTest{
        ...
        val result  = loginByFirebaseUseCaseImpl(email,password)
