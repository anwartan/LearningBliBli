...
import com.example.learningblibli.core.domain.usecase.impl.GetFavoriteMealUsecaseImpl
...
class GetFavoriteMealUsecaseImplTest{
    ...
    @InjectMocks
    private lateinit var getFavoriteMealUsecaseImpl: GetFavoriteMealUsecaseImpl
    ...
    fun getFavoriteMeal(){
        ...
        val actualResult = getFavoriteMealUsecaseImpl().getOrAwaitValue()
